...
"[project]/src/app/(authenticated)/capture/capture-form.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const CaptureForm = ({ projects })=>{
    const [projectId, setProjectId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(projects[0]?.id ?? "");
    ...
    const handleSubmit = async (event)=>{
        ...
        if (!response.ok) {
            setStatus("error");
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Unable to save note. Try again.");
            return;
        }
        setContent("");
        setStatus("success");
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("Captured to timeline");
...
//# sourceMappingURL=src_ed528944._.js.map