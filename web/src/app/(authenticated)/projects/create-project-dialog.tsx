...
export const CreateProjectDialog = ({ children }: CreateProjectDialogProps) => {
  ...
  const onSubmit = async (values: FormValues) => {
    ...
    if (!response.ok) {
      form.setError("name", { message: "Unable to create project. Try again." });
      return;
    }
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Strategic account expansion" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea placeholder="Context for why this matters" rows={3} {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea placeholder="Notes you want to keep handy" rows={3} {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
